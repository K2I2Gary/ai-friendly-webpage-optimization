# sitemap.md is published

> sitemap.md is a human- and agent-readable version of sitemap.xml. It's the same idea as sitemap.xml but in the format agents most prefer to ingest, and unlike llms.txt it can carry full hierarchical structure with section headings.

`site` | `Discoverability` | `impl 1.0.0` | `sitemap-md.exists`
