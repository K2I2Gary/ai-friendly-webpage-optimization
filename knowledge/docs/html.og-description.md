...
> og:description is the partner of og:title and serves the same purpose, a clean, structured summary that agents can read without parsing the body. It's the difference between an agent showing your page as a one-line preview versus a URL.

`page` | `HTML metadata` | `impl 1.0.0` | `html.og-description`
