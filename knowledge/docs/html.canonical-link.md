...
> Agents follow canonical links to deduplicate the same content reachable at multiple URLs. Without one, RAG ingesters store the same article under several URLs and waste context window capacity.

`page` | `HTML metadata` | `impl 1.0.0` | `html.canonical-link`
