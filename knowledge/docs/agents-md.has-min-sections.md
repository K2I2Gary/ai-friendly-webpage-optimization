# agent skill file documents at least 2 of install/config/usage

> An AGENTS.md that only has a project description is barely better than no file at all. Agents need actionable instructions, install, configure, use, to do anything useful with your project.

`site` | `Discoverability` | `impl 1.0.0` | `agents-md.has-min-sections`
